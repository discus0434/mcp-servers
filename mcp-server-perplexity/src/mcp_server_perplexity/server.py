        ...
        types.Prompt(
            ...
            arguments=[
                types.PromptArgument(
                    name="query",
                    description="The search query to find information about. Your query MUST be written in English or Chinese, which has the greatest abundance of information on the web.",
                    required=True,
                ),
                types.PromptArgument(
                    name="recency",
...
async def call_perplexity(query: str, recency: str) -> str:
    ...
    # Get the model from environment variable or use "sonar-reasoning-pro" as default
